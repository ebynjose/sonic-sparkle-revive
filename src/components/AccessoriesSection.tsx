...
const AccessoriesSection = () => {
  ...
  return (
    <section id="accessories" className="py-32 overflow-hidden">
      ...
      <div
        ref={scrollRef}
        className="flex gap-4 overflow-x-auto no-scrollbar px-6 lg:px-[calc((100vw-1200px)/2+1.5rem)]"
      >
        {items.map((item, i) => (
          <motion.div
            key={item.name}
          ...
          >
            <div className="p-6 rounded-xl bg-card border border-border hover:border-primary/30 transition-all duration-500 h-full hover:glow-sm">
              <item.icon
                size={24}
